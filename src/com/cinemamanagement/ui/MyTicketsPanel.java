...
public class MyTicketsPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        refreshButton = new RounedButton("Làm Mới Danh Sách Vé", new Color(255, 193, 7));
        ...
        ticketsTable.setBackground(new Color(255, 255, 240)); // Very light yellow
        ticketsTable.setSelectionBackground(new Color(255, 153, 102)); // Light orange for selected row
        ticketsTable.setSelectionForeground(Color.WHITE);
        TableRowSorter<DefaultTableModel> sorter = new TableRowSorter<>(tableModel);
        ticketsTable.setRowSorter(sorter);
        ticketsTable.setPreferredScrollableViewportSize(new Dimension(800, 300));
